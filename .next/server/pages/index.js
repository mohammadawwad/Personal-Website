...
const SectionSubText = external_styled_components_default().p.withConfig({
  ...
  componentId: "sc-1ehwjfm-4"
})(["max-width:800px;font-weight:300;font-size:18px;line-height:32px;color:var(sectionSubText);@media ", "{max-width:672px;font-size:16px;line-height:25px;}@media ", "{font-size:14px;line-height:22px;}"], props => props.theme.breakpoints.md, props => props.theme.breakpoints.sm);
const SecondaryBtn = external_styled_components_default().button.withConfig({
  displayName: "GlobalComponents__SecondaryBtn",
  componentId: "sc-1ehwjfm-5"
...
const Intro = external_styled_components_default().div.withConfig({
  ...
  componentId: "sc-1x25wey-6"
})(["width:170px;margin:0 auto;color:#dce3e7;font-family:'Droid Serif',serif;font-size:13px;font-style:italic;line-height:18px;"]);
const CardInfo = external_styled_components_default().p.withConfig({
  displayName: "ProjectsStyles__CardInfo",
  componentId: "sc-1x25wey-7"
})(["width:100%;padding:0 50px;color:#e4e6e7;font-style:2rem;line-height:24px;text-align:justify;transition:0.4s @media ", "{padding:.3rem}"], props => props.theme.breakpoints.sm);
const UtilityList = external_styled_components_default().ul.withConfig({
  displayName: "ProjectsStyles__UtilityList",
  componentId: "sc-1x25wey-8"
})(["list-style-type:none;padding:0;display:flex;justify-content:space-around;margin:2.5rem 0;"]);
const ExternalLinks = external_styled_components_default().a.withConfig({
  displayName: "ProjectsStyles__ExternalLinks",
  componentId: "sc-1x25wey-9"
})(["color:rgb(255,255,255);font-size:1.6rem;padding:1rem 1.5rem;background:rgb(60 118 145 / 70%);border-radius:15px;transition:0.5s;&:hover{background:#801414;}"]);
const TagList = external_styled_components_default().ul.withConfig({
  displayName: "ProjectsStyles__TagList",
  componentId: "sc-1x25wey-10"
})(["display:flex;justify-content:space-around;padding:2rem;"]);
const Tag = external_styled_components_default().li.withConfig({
  displayName: "ProjectsStyles__Tag",
  componentId: "sc-1x25wey-11"
})(["color:rgb(111 150 213);font-size:1.5rem;"]);
...
const data = [{
  ...
  number: "Winner",
  text: 'Recieved chairmans prestigious FRC award'
}, {
  number: "3rd Place",
  text: '2022 Victoria Frc Competition'
}, {
  number: "Course",
  text: 'Simon Fraser University Web Dev Course'
}]; // export const Color = () => {
//   let color = false;
//   if(color == false){
//     console.log(color);
  ...
  children: /*#__PURE__*/jsx_runtime_.jsx(Section, {
    ...
    children: /*#__PURE__*/(0,jsx_runtime_.jsxs)(LeftSection, {
      children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)(SectionTitle, {
        ...
        children: ["Hi, I'm Mohammad", /*#__PURE__*/jsx_runtime_.jsx("br", {}), "Awwad"]
      }), /*#__PURE__*/jsx_runtime_.jsx(SectionText, {
        children: "A lead programmer on my high schools robotics team, I am passionate about programming, and I\u2019m always wanting to learn new things as well as teach others."
...
const ListTitle = external_styled_components_default().h4.withConfig({
  ...
  componentId: "sc-136bsbk-4"
})(["font-weight:700;font-size:28px;line-height:32px;letter-spacing:0.02em;color:var(sectionText);margin-bottom:8px;@media ", "{font-size:24px;line-height:28px;}@media ", "{font-size:20px;line-height:28px;letter-spacing:0.02em;margin-bottom:4px;}"], props => props.theme.breakpoints.md, props => props.theme.breakpoints.sm);
const ListParagraph = external_styled_components_default().p.withConfig({
  displayName: "TechnologiesStyles__ListParagraph",
  componentId: "sc-136bsbk-5"
})(["font-size:18px;line-height:30px;color:var(sectionText);@media ", "{font-size:16px;line-height:28px;}@media ", "{font-size:14px;line-height:22px;}"], props => props.theme.breakpoints.md, props => props.theme.breakpoints.sm);
const ListItem = external_styled_components_default().li.withConfig({
  displayName: "TechnologiesStyles__ListItem",
  componentId: "sc-136bsbk-6"
...
const CarouselItem = external_styled_components_default().div.withConfig({
  ...
  componentId: "sc-1f1tj41-2"
})(["background:var(blackAndWhite);border-radius:3px;max-width:196px;@media ", "{max-width:124px;}@media ", "{margin-left:32px;min-width:120px;background:var(blackAndWhite);padding:4px;align-content:start;scroll-snap-align:start;border-radius:3px;overflow:visible;position:relative;height:fit-content;", ";}"], props => props.theme.breakpoints.md, props => props.theme.breakpoints.sm, props => props.active === props.index ? `opacity: 1` : `opacity: 0.5`);
const CarouselItemTitle = external_styled_components_default().h4.withConfig({
  displayName: "TimeLineStyles__CarouselItemTitle",
  componentId: "sc-1f1tj41-3"
...
const CarouselItemText = external_styled_components_default().p.withConfig({
  ...
  componentId: "sc-1f1tj41-5"
})(["font-size:14px;line-height:22px;letter-spacing:0.02em;color:var(sectionSubText);padding-right:16px;@media ", "{font-size:12px;line-height:18px;padding-right:32px;}@media ", "{font-size:10px;line-height:16px;padding-right:0;}"], props => props.theme.breakpoints.md, props => props.theme.breakpoints.sm);
const CarouselButtons = external_styled_components_default().div.withConfig({
  displayName: "TimeLineStyles__CarouselButtons",
  componentId: "sc-1f1tj41-6"
...
const CarouselButtonDot = external_styled_components_default().div.withConfig({
  ...
  componentId: "sc-1f1tj41-8"
})(["background-color:var(blackAndWhite);border-radius:10px;margin:auto;width:3px;height:3px;"]);
...
const Container = external_styled_components_default().div.withConfig({
  ...
  componentId: "sc-1l82ld4-0"
})(["display:grid;grid-template-columns:repeat(5,1fr);grid-template-rows:1fr;grid-column-gap:2rem;padding:1rem;padding-top:2rem;z-index:100;box-shadow:rgb(80 78 78 / 50%) 0px 9px 20px 5px;@media ", "{display:grid;grid-template-columns:repeat(5,1fr);grid-template-rows:repeat(2,60px);grid-column-gap:0.5rem;grid-row-gap:0.5rem;}"], props => props.theme.breakpoints.sm);
const Div1 = external_styled_components_default().div.withConfig({
  displayName: "HeaderStyles__Div1",
  componentId: "sc-1l82ld4-1"
...
const NavLink = external_styled_components_default().a.withConfig({
  ...
  componentId: "sc-1l82ld4-4"
})(["font-size:2rem;line-height:32px;color:var(header);transition:0.3s ease;&:hover{color:#fff;opacity:1;cursor:pointer;font-size:2.2rem;}@media ", "{padding:0.5rem;}"], props => props.theme.breakpoints.sm); /// DropDown Contact

const ContactDropDown = external_styled_components_default().button.withConfig({
  displayName: "HeaderStyles__ContactDropDown",
  componentId: "sc-1l82ld4-5"
...
const SocialIcons = external_styled_components_default().a.withConfig({
  ...
  componentId: "sc-1l82ld4-7"
})(["transition:0.3s ease;color:rgba(255,255,255,1);border-radius:50px;padding:8px;transition:0.3s;&:hover{background-color:#212d45;transform:scale(1.2);cursor:pointer;}"]);
...
const Slogan = external_styled_components_default().p.withConfig({
  ...
  componentId: "otoyry-4"
})(["color:var(blackAndWhite);min-width:280px;letter-spacing:0.02em;font-size:18px;line-height:30px;padding:1rem;@media ", "{font-size:16px;line-height:28px;}@media ", "{line-height:22px;font-size:14px;min-width:100px;}"], props => props.theme.breakpoints.md, props => props.theme.breakpoints.sm);
const SocialContainer = external_styled_components_default().div.withConfig({
  displayName: "FooterStyles__SocialContainer",
  componentId: "otoyry-5"
...
const LinkTitle = external_styled_components_default().h4.withConfig({
  ...
  componentId: "otoyry-8"
})(["font-style:normal;font-weight:600;font-size:12px;line-height:24px;text-transform:uppercase;color:rgba(255,255,255,1);margin-bottom:16px;@media ", "{font-size:10px;line-height:12px;margin-bottom:8px;}"], props => props.theme.breakpoints.sm);
    ...
    children: [/*#__PURE__*/jsx_runtime_.jsx(LinkList, {
      children: /*#__PURE__*/(0,jsx_runtime_.jsxs)(LinkColumn, {
        children: [/*#__PURE__*/jsx_runtime_.jsx(LinkTitle, {
          ...
          children: ["Lock", /*#__PURE__*/jsx_runtime_.jsx(Popup, {})]
        })]
      })
...
var Header_CustomThemeHook = __webpack_require__(334);
// EXTERNAL MODULE: ./src/styles/theme.js + 3 modules
var theme = __webpack_require__(232);
...
const MaterialUISwitch = (0,styles_.styled)((Switch_default()))(({
  theme
}) => ({
  width: 62,
  height: 34,
...
function CustomizedSwitch() {
  const {
    value,
    setValue
  } = CustomThemeHook(); //function that handles event change of buttton and allows for theme to actually change

  const handleChange = event => {
    setValue(event.target.checked);
    localStorage.setItem("themeValue", event.target.checked); // Color();
  };

  return /*#__PURE__*/_jsxs(_Fragment, {
    children: [/*#__PURE__*/_jsx(FormControlLabel, {
      control: /*#__PURE__*/_jsx(MaterialUISwitch, {
        checked: value,
...
var __webpack_exports__ = __webpack_require__.X(0, [400,664,232], () => (__webpack_exec__(489)));
